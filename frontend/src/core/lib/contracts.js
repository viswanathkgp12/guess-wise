...
import PredictionMktAbi from './abi/predictionMarket.json'
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
} from './constants.js'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.predictionMkt = new this.web3.eth.Contract(PredictionMktAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(
      this.predictionMkt,
      contractAddresses.predictionMarket[networkId],
    )
  }
